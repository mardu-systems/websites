 ...
 */
import type { AggregateParameter } from './aggregateParameter';
import type { FilterParameter } from './filterParameter';
import type { GroupByParameter } from './groupByParameter';
import type { IncludeRecordsSampleParameter } from './includeRecordsSampleParameter';
import type { LimitParameter } from './limitParameter';
import type { OrderByForRecordsParameter } from './orderByForRecordsParameter';
import type { OrderByParameter } from './orderByParameter';
import type { ViewIdParameter } from './viewIdParameter';

export type GroupByNoteTargetsParams = {
  /**
   * Array of fields to group by. Each element can specify a field and optionally a subfield or granularity for date fields.
   */
 ...
 */
  ...
  /**
   * View ID to apply filters from.
   */
  view_id?: ViewIdParameter;
  /**
   * Array of aggregate operations to compute for each group.
   */
  aggregate?: AggregateParameter;
  /**
   * If true, includes a sample of records for each group in the response.
   */
  include_records_sample?: IncludeRecordsSampleParameter;
  /**
   * Order by clause for records within each group. Only applicable when include_records_sample is true.
   */
  order_by_for_records?: OrderByForRecordsParameter;
};

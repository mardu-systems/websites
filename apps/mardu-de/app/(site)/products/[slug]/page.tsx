...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      images: imageUrl
        ? [{ url: imageUrl, alt: product.ogImageAlt ?? product.imageAlt }]
        : undefined,
    },
    twitter: {
...
export default async function ProductDetailPage({
  ...
  const catalogProduct = createProductCatalogItems([], [product], getContentOrigin())[0];
  ...
  return (
    <main>
      ...
      />
      <ProductDetailPageContent product={catalogProduct} selectedVariantId={selectedVariantId} />
    </main>
  );
}

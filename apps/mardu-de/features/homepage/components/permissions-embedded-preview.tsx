...
const identityRows = [
  {
    id: 'local-admin',
    userName: 'local.admin@mardu.example',
    displayName: 'Lokale Administration',
    email: 'local.admin@mardu.example',
    emailConfirmed: true,
    imageUrl: null,
  ...
  {
    id: 'ldap-member',
    userName: 'campus.member@mardu.example',
    displayName: 'Campusmitglied',
    email: 'campus.member@mardu.example',
    emailConfirmed: true,
    imageUrl: null,
    identitySource: 'ldap',
    identityProvider: 'Campus Directory',
    status: 'active',
  ...
  {
    id: 'lab-management',
    userName: 'lab.management@mardu.example',
    displayName: 'Laborverwaltung',
    email: 'lab.management@mardu.example',
    emailConfirmed: true,
    imageUrl: null,
    identitySource: 'local',
    status: 'active',
  ...
  {
    id: 'ldap-guest',
    userName: 'guest.account@mardu.example',
    displayName: 'Temporärer Gastzugang',
    email: 'guest.account@mardu.example',
    emailConfirmed: true,
    imageUrl: null,
    identitySource: 'ldap',
    identityProvider: 'Partner Directory',
    status: 'inactive',
    twoFactorEnabled: false,
    tagCount: 1,
  },
  {
    id: 'oidc-supervision',
    userName: 'supervision@mardu.example',
    displayName: 'Maschinenaufsicht',
    email: 'supervision@mardu.example',
    emailConfirmed: true,
    imageUrl: null,
    identitySource: 'oidc',
    identityProvider: 'Microsoft Entra ID',
  ...
  {
    id: 'local-service',
    userName: 'service.account@mardu.example',
    displayName: 'Lokales Servicekonto',
    email: 'service.account@mardu.example',
  ...
  if (variant === 'identities') {
    return (
      <EmbeddableUserTable
        {...sharedTableProps}
        title="Benutzer"
        description="Identitäten, Quellen und Kontosicherheit zentral verwalten."
        data={identityRows}
      />
    );
  }

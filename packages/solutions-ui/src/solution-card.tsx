...
const toneClasses: Record<SolutionThemeTone, string> = {
  ...
  sand: "bg-[radial-gradient(circle_at_top_left,rgba(214,171,84,0.14),transparent_30%),linear-gradient(180deg,#fbf8ef_0%,#f7f1df_100%)]",
  mist: "bg-[radial-gradient(circle_at_top_left,rgba(75,136,168,0.12),transparent_30%),linear-gradient(180deg,#fbf8ef_0%,#f6f3ea_100%)]",
  clay: "bg-[radial-gradient(circle_at_top_left,rgba(168,102,69,0.13),transparent_30%),linear-gradient(180deg,#fbf8ef_0%,#f6efe7_100%)]",
...
export function SolutionCard({ solution, href, className }: SolutionCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[6/5] overflow-hidden border-b border-border bg-muted/50">
        <Image

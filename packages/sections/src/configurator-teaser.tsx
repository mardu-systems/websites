...
const DEFAULT_HIGHLIGHTS: ConfiguratorTeaserFeature[] = [
  ...
  {
    title: "Maschinen",
    description: "Freigaben und Leistungsbedarf skizzieren",
  },
  {
    title: "Rahmen",
    description: "Nutzer, Rollen und Betriebsmodell einordnen",
  },
];
              ...
              <div className="space-y-8">
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  {highlights.map((item) => (
                    <div
                      key={item.title}
                      className="border border-black/10 bg-background/70 p-4"
                    >

...
import { EditorialBrandAssetsPage } from "./brand-assets-editorial";
import Faq from "./faq";
...
export type BrandAssetUsageRuleDto = { question: string; answer: string };
...
export type BrandAssetsPageProps = {
  ...
  className?: string;
  /**
   * `editorial-index` follows the numbered, high-contrast Mardu marketing layout;
   * `default` preserves the compact resource layout.
   */

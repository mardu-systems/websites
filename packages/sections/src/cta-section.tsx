 ...
 * The section keeps the original mardu.de dialog UX and exposes only small app-owned hooks.
 */
...
export default function CTASection({
  ...
  const dialogConfig = { ...DEFAULT_DIALOG, ...newsletterDialog };
  ...
  const opensNewsletterDialog = !primaryButtonHref;
